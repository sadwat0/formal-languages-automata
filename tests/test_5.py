...
def test_nfa_to_regex():
    ...
    # The exact string representation might vary, so we'll check if it contains expected components
...
def test_regex_equivalence():
    ...
    # Create NFAs from the generated regexes
...
#     # Create new automata from the generated regexes
